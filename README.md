...
Весь код переехал из данного репозитория в репо HomeAssistant аддона, данный код мною обновляться больше не будет.
...
- 21-03-2021: Код моста переехал в репозиторий HA аддона.
